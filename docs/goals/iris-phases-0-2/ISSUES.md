...
| P2-06 | active   | Migrate legacy pending cards; make chat/overlays transaction projections                                             | Migration / reload tests                          | P2-03, P2-05 |

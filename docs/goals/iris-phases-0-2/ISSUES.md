...
| P2-02 | active   | Cut anchored insertion over to batch-of-one acknowledgement                                                          | Transaction service / cursor-reload browser tests | P2-01        |
